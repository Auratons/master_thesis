...
their usage for varying problem settings. Please see the \nameref{chap:conclusion} for more details.
...
\nameref{chap:pose_verification}. The last chapter then gets to
