...
is used, unless otherwise said. In other words, a 3D colored point cloud obtained from the \uv{implicit}
...
cloud file. To our best knowledge, such a headless surface \uv{splatter} did not exist before.
...
\nameref{chap:conclusion} chapter for more details.

\section*{Thesis Structure}
\addcontentsline{toc}{section}{Thesis Structure}

The thesis is divided into three chapters. The \emph{first chapter},
\nameref{chap:visual_loc}, presents the visual localization
methods and presents the InLoc localization pipeline and the
reason why the method is chosen for further investigation.
The \emph{second chapter}, \nameref{chap:pcd_rendering}, presents
...
\nameref{chap:pose_verification}. This last chapter then gets to
